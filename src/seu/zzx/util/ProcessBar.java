 ...
 *
 */
public class ProcessBar implements ActionListener {
    ...
    public static void show(Window parent, Thread thread) {
        new ProcessBar(parent, thread, DEFAULT_STATUS, null, null);
    }
    /**
     * 显示进度条测试对话框
     * @param parent
    ...
    public static void show(Window parent, Thread thread, String statusInfo) {
        new ProcessBar(parent, thread, statusInfo, null, null);
    }
    ...
    public static void show(Window parent, Thread thread, String statusInfo,
        ...
        new ProcessBar(parent, thread, statusInfo, resultInfo, cancelInfo);
    }
     ...
     * @param cancelInfo
     */
    private ProcessBar(Window parent, Thread thread, String statusInfo,
            String resultInfo, String cancelInfo) {
        this.parent = parent;
        this.thread = thread;
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        //显示进度条测试对话框
        ProcessBar.show((Frame) null, thread, "正在导入。。。", "导入成功！", "Cancel");
